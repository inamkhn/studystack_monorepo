...
import { PracticeProblemController } from "./practice-problem.controller.js";
...
@Module({
  ...
  controllers: [QuizController, FinalProjectController, PracticeProblemController],
  providers: [QuizService, FinalProjectService, PracticeProblemService],
})
